...
class Perceiver(nn.Module):
    def __init__(self, embed_dim, num_latents, latents_self_attn=True, num_heads=8, attn_dropout=0.0, bias=False):
        super().__init__()
        self.embed_dim = embed_dim
        self.num_latents = num_latents
        self.num_heads = num_heads
        self.bias = bias
        self.latents_self_attn = latents_self_attn
...
class PPIAttnLoRA(nn.Module):
    def __init__(
        ...
        self.perceiver = Perceiver(
            ...
            latents_self_attn=latents_self_attn,
            num_heads=num_heads,
...
def main():
    ...
    print(downstream_model.perceiver.num_latents)

    run_name = create_run_name(
        backbone=ckpt,
        setup="lora_perceiver_1024",
        r=r,
        alpha=alpha,
        target_modules=target_modules,
    )
